# Contributing to img2img-api

Thank you for your interest in contributing to img2img-api! Contributions from the community are welcome and appreciated.
...
2. Clone your fork to your local machine:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/img2img-api.git
   ```
...
Please check the [issues](https://github.com/img2img-api/issues) tab to see where help is needed.
...
By contributing to img2img-api, you agree that your contributions will be licensed under the same license as the project.
