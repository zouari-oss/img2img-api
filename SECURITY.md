# Security Policy for img2img-api

## Supported Versions

The img2img-api project provides security updates for the following versions:
...
If you discover a security vulnerability in img2img-api, we encourage responsible disclosure. To report a vulnerability:
...
We appreciate the security community's efforts in helping us maintain img2img-api’s safety and integrity.

## Security Practices

img2img-api follows industry best practices for security to ensure safe transactions and protect user data:

### 1. **Authentication and Authorization**

- img2img-api uses secure methods for user authentication, including strong password hashing (e.g., bcrypt).
...
Contributors can help enhance img2img-api's security by following these practices:
...
Thank you for helping us make img2img-api secure for our users and the community!
